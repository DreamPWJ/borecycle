...
gulp.task('default', ['mergeMiniJsCss','minifyCss','minifyJs','minImages','copyHtml','copyFonts','copyLib','copyBankInfo']);
...
/*复制bankinfo*/
gulp.task('copyBankInfo', function () {
  return gulp.src('./www/js/*.json')      //复制的文件
  /*    .pipe(minifyCss()) */   //执行压缩
    .pipe(gulp.dest('./borecycle/js/'));  //输出文件夹
});
/*复制Lib*/
